            ...
            if self.learned_interface is not None:
                ...
                for interface in self.learned_interface:
                    ...
                    if 'flow_control' in self.learned_interface[interface]:
                        ...
                        flow_control_receive = "N/A"
                        flow_control_send = "N/A"
