...
urlpatterns = [
    ...
    path('ShowLicenseSummary/All/', views.show_license_summary_all),
    path('ShowLicenseSummary/<int:year>/', views.show_license_summary_year_archive),
    path('ShowLicenseSummary/<int:year>/<int:month>/', views.show_license_summary_month_archive),
    path('ShowLicenseSummary/<int:year>/<int:month>/<int:day>/', views.show_license_summary_day_archive),
    path('ShowLicenseSummary/nxos/', views.show_license_summary_nxos_archive),
    path('ShowLicenseSummary/<str:pyats_alias>/', views.show_license_summary_alias_archive),      
