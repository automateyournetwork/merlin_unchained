...
router.register(r'EoX_PID', views.EoX_PIDViewSet)
router.register(r'EoX_SN', views.EoX_SNViewSet)
router.register(r'EoX_SW', views.EoX_SWViewSet)
...
router.register(r'NMAP', views.NMAPViewSet)
...
router.register(r'ShowLicenseSummary', views.ShowLicenseSummaryViewSet)
