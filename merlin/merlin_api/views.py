...
class EoX_SWViewSet(viewsets.ModelViewSet):
    queryset = EoX_IOS.objects.all().order_by('timestamp')
    serializer_class = EoX_SWSerializer
...
class ShowLicenseSummaryViewSet(viewsets.ModelViewSet):
    queryset = ShowLicenseSummary.objects.all().order_by('timestamp')
    serializer_class = ParseShowLicenseSummarySerializer
