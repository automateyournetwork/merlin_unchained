...
from merlin.models import LearnVRF, ShowVersion
        ...
        for device in testbed:
            ...
            if self.learned_vrf is not None:
                ...
                for vrf in self.learned_vrf['vrfs']:
                    learnVRF=LearnVRF(hostname=device.alias,os=device.os,vrf=vrf,address_family_ipv4=self.learned_vrf['vrfs'][vrf]['address_family']['ipv4'],address_family_ipv6=self.learned_vrf['vrfs'][vrf]['address_family']['ipv6'],route_distinguisher=self.learned_vrf['vrfs'][vrf]['route_distinguisher'],timestamp=datetime.now())
